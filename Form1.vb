...
#End Region
    ...
    Private Sub attachFile_Click(sender As Object, e As EventArgs) Handles attachFile.Click
        ...
        If OpenFileDialog2.ShowDialog = 1 Then
            attachf.Text = OpenFileDialog2.FileName
        End If
    ...
    Private Sub KryptonLinkLabel1_LinkClicked(sender As Object, e As EventArgs) Handles Roast247Github.LinkClicked
    ...
    Private Sub Commas_Click(sender As Object, e As EventArgs) Handles Commas.CheckedChanged


        If Commas.Checked = True Then
            mainMail.Text = String.Join("," & Environment.NewLine, mainMail.Lines)
        End If

        If Commas.Checked = False Then
            mainMail.Lines = mainMail.Lines.Select(Function(line) line.TrimEnd(","c)).ToArray()
        End If
    ...
    Private Sub Noticemsg_LinkClicked(sender As Object, e As EventArgs) Handles Noticemsg.LinkClicked
        Notice.Show()
    End Sub

    Private Sub ClearSMTP_Click(sender As Object, e As EventArgs) Handles ClearSMTP.Click
        smtpHost.Text = ("")
        smtpPort.Text = ("")
        userPass.Text = ("")
        userMail.Text = ("")
